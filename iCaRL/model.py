...
class iCaRLNet(nn.Module):
    def __init__(self, feature_size, n_classes):
        ...
        self.fc1 = nn.Linear(1000, feature_size)
    ...
    def combine_dataset_with_exemplars(self, dataset, loader):
        for y, P_y in enumerate(self.exemplar_sets):
            exemplar_images = P_y
            exemplar_labels = [y] * len(P_y)
            loader.dataset.imgs.append(exemplar_images)
            loader.dataset.targets.append(exemplar_labels)


    def update_representation(self, dataset,classes, loader):
        ...
        self.combine_dataset_with_exemplars(dataset, loader)
